...
int puntaje1_alto = 275; // Nivel Alto del sensor dedo pulgar
int puntaje1_bajo = 118; // Nivel Bajo del sensor dedo pulgar
int puntaje2_alto = 255; // Nivel Alto del sensor dedo índice
int puntaje2_bajo = 108; // Nivel Bajo del sensor dedo índice
int puntaje3_alto = 283; // Nivel Alto del sensor dedo corazón
int puntaje3_bajo = 127; // Nivel Bajo del sensor dedo corazón
int puntaje4_alto = 263; // Nivel Alto del sensor dedo anular
int puntaje4_bajo = 104;  // Nivel Bajo del sensor dedo anular
int puntaje5_alto = 280; // Nivel Alto del sensor dedo meñique
int puntaje5_bajo = 114; // Nivel Bajo del sensor dedo meñique
